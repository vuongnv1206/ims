...
```
cd existing_repo
git remote add origin https://gitlab.com/group68173737/ImsApplication.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/group68173737/ImsApplication/-/settings/integrations)
